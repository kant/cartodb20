  ...
  cdb.admin.UpgradeDialog = cdb.admin.BaseDialog.extend({
    ...
    render_content: function() {
      ...
      // Add ghost form
      this.$content.prepend('<form class="hide" action="' + window.location.protocol + '//' + this.options.config.account_host + '/account/' + username + '/upgrade" method="get"><input type="text" name="account_type" value="" /></form>');
